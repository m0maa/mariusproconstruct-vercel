// Icon components for trades template
// Using lucide-react patterns
...
export const Hammer = ({ className = "" }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="m15 12-8.5 8.5c-.83.83-2.17.83-3 0 0 0 0 0 0 0a2.12 2.12 0 0 1 0-3L12 9" />
    <path d="M17.64 15 22 10.64" />
    <path d="m20.91 11.7-1.25-1.25c-.6-.6-.93-1.4-.93-2.25V7.86c0-.55-.45-1-1-1H16.14c-.85 0-1.65-.33-2.25-.93L12.64 4.64c-.6-.6-1.4-.93-2.25-.93H9.86c-.55 0-1 .45-1 1v1.36c0 .85-.33 1.65-.93 2.25L5.64 10.36c-.6.6-.93 1.4-.93 2.25v.54c0 .55.45 1 1 1h1.36c.85 0 1.65.33 2.25.93l1.25 1.25c.6.6 1.4.93 2.25.93h.54c.55 0 1-.45 1-1V16.14c0-.85.33-1.65.93-2.25l1.25-1.25c.6-.6.93-1.4.93-2.25v-.54c0-.55-.45-1-1-1h-1.36c-.85 0-1.65-.33-2.25-.93Z" />
  </svg>
)

export const Paintbrush = ({ className = "" }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="m18.645 11.856-3.468 3.468" />
    <path d="m2.229 21.487 3.515-3.515a2.5 2.5 0 0 0 0-3.535l-1.48-1.48a2.5 2.5 0 0 0-3.535 0l-3.515 3.515a4.002 4.002 0 0 0 .555 5.196l.5.5a4.002 4.002 0 0 0 5.196.555Z" />
    <path d="m17.645 8.645 3.515-3.515a3.002 3.002 0 0 0 0-4.243 3.002 3.002 0 0 0-4.243 0l-3.515 3.515" />
    <path d="M8.5 12.5a2.12 2.12 0 0 1 3 3" />
  </svg>
)

export const BrickWall = ({ className = "" }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M6 5h12" />
    <path d="M6 9h12" />
    <path d="M6 13h12" />
...
export const Roof = ({ className = "" }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M12 22v-8" />
...
export const Circuitry = ({ className = "" }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
export const Plug = ({ className = "" }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    ...
    <path d="M9 12v2" />
    <path d="M15 12v2" />
    <path d="M12 12a4 4 0 0 0-4 4v2a2 2 0 0 0 2 2h4a2 2 0 0 0 2-2v-2a4 4 0 0 0-4-4Z" />
    <path d="M12 2v2" />
    <path d="M8 7.5a4.5 4.5 0 0 1 8 0" />
    <path d="M5 22h14" />
  </svg>
)
...
export const Star = ({ className = "", filled = false }: { className?: string; filled?: boolean }) => (
